...
setwd("C:\\Users\\Administrator.PC-20180729NNFB\\Desktop\\M7g\\30.GO")                     #设置工作目录
rt=read.table("TCGA.riskDiff.txt", header=T, sep="\t", check.names=F)     #读取输入文件
